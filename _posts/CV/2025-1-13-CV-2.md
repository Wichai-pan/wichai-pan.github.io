...
Gaussian smoothing
- The result of applying Gaussian Filter on the image is blurring and reducing the noise fromthe image
...
- Strong pixels are pixels that have an intensity so high that we are sure they contribute tothe final edge
